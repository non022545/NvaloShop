...
function Home() {
    return (
        <div>
            ...
            <div className="h-auto min-h-screen bg-cover bg-center text-white px-6 py-12 flex flex-col items-center justify-center text-center" style={{ backgroundImage: "url('https://images7.alphacoders.com/136/thumbbig-1369073.webp')" }}>
